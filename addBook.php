    ...
    if(isset($_POST['submit'])){
        ...
        move_uploaded_file($book_pic_temp,"img/books/$book_pic");
         ...
         $discription = mysqli_real_escape_string($connection,$discription);
          ...
          $query = "INSERT INTO books(bid,bookName,bcategory,bDate,cnumber,discription,image) VALUES ('{$bid}','{$bookName}','{$bcategory}','{$bDate}','{$cnumber}','{$discription}','{$book_pic}')";
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mt-5 ml-end">
                    <img src="./img/add book.png" alt="Book image" class="img-fluid mb-3 rounded-left event-pic">
            </div>
            <div class="col-md-4 text-center ">
                <h1 class="text-dark"><u>ADD BOOKS</u></h1>
                <div class="d-flex">
                       
                        <div class="p-4 align-self-end ">
                            <h2>
                            <strong> If you wants to Add Books Click below button,You can Add book name id description about book using the form </strong><br><br>
                            <button class="btn btn-primary" data-toggle="modal" data-target="#contactmodal"><i class="fas fa-book"></i>   Add Books</button>
                            </h2>
                        </div>  
                </div>
            ...
            <div class="modal-body">
                ...
                <form action="" method="POST" onsubmit="return validation()" class="bg-light" enctype="multipart/form-data">
                    ...
                    <select type="text" class="custom-select d-block w-100" id="bcategory" name="bcategory" >
                        ...
                        <option value="JAVA">LOVE</option>
                        <option value="java">HISTORY</option>
                        <option value="web">SUJEE</option>
                        <option value="android">SARA</option>
                         </select>
