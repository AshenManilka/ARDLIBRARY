            ...
            <div class="container">
                <div class="row ">
                    <div class="col text-center py-5 "> 
                            <h1 class="display-4"><i class="fas fa-book-open"></i> EVENTS</h1>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-12"><br>
              <h2 class="page-header text-center" id="event-header"><span class="text-danger" ><b> Books</b></span></h2><br><br>
...
?>
              ...
              <div class="thumbnail">
                <div class="inner">
                  <a href="#"> <img src="./img/events/<?php echo $image;  ?>" height="300" width="300" alt="new-arrivals1"></a>
                </div>
