                      ...
                      <div class="row mbr-justify-content-center">
                              ...
                              <div class="col-lg-6 mbr-col-md-10">
                                  <div class="wrap">
                                      ...
                                      <div class="btn text-wrap vcenter" href = "./addEvents.html">   
                                          ...
                                          <p class="mbr-fonts-style text1 mbr-text display-6">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</p>
                                          <a href="./addEvents.html" class="btn btn-outline-info main-btn lib-btn my-4  text-capitalize"> Add Events</a>
                                        </div>
                                      </div>
                              ...
                              <div class="col-lg-6 mbr-col-md-10">
                                  <div class="wrap">
                                      ...
                                      <div class="text-wrap vcenter">
                                          <h2 class="mbr-fonts-style mbr-bold mbr-section-title3 display-5"> <span>GENERATE REPORT</span></h2>
                                          <p class="mbr-fonts-style text1 mbr-text display-6">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum</p>
                                          <a href="./addEvents.php" class="btn btn-outline-info main-btn lib-btn my-4  text-capitalize"> Genarate Report</a>
                                        </div>
                                  </div>
                              </div>
